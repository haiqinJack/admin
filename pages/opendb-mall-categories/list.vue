<template>
  <view>
    ...
    <view class="uni-container">
      <unicloud-db ref="udb" :collection="collectionList" field="name,icon,sort,description,is_hot_show,is_index_show" :where="where" page-data="replace"
        ...
        <uni-table ref="table" :loading="loading" :emptyText="error.message || '没有更多数据'" border stripe type="selection" @selection-change="selectionChange">
          <uni-tr>
            ...
            <uni-th align="center" sortable @sort-change="sortChange($event, 'icon')">图标地址</uni-th>
            ...
            <uni-th align="center" sortable @sort-change="sortChange($event, 'is_hot_show')">加入热门显示</uni-th>
            <uni-th align="center" sortable @sort-change="sortChange($event, 'is_index_show')">首页显示</uni-th>
