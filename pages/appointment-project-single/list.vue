<template>
  <view>
    ...
    <view class="uni-container">
      <unicloud-db ref="udb" :collection="collectionList" field="project_id{title as text},title,bannerfile,price,order,detailed" :where="where" page-data="replace"
        :orderby="orderby" :getcount="true" :page-size="options.pageSize" :page-current="options.pageCurrent"
        v-slot:default="{data,pagination,loading,error,options}" :options="options" loadtime="manual" @load="onqueryload">
        <uni-table ref="table" :loading="loading" :emptyText="error.message || '没有更多数据'" border stripe type="selection" @selection-change="selectionChange">
          <uni-tr>
            <uni-th align="center">project_id</uni-th>
            ...
            <uni-th align="center" sortable @sort-change="sortChange($event, 'detailed')">详情图</uni-th>
          ...
          <uni-tr v-for="(item,index) in data" :key="index">
            ...
            <uni-td align="center">
              <template v-for="(file, j) in item.detailed">
...
<script>
  import { enumConverter, filterToWhere } from '../../js_sdk/validator/appointment-project-single.js';
  ...
  export default {
    data() {
      return {
        collectionList: [ db.collection('appointment-project-single').getTemp(), db.collection('appointment-project').getTemp() ],
        query: '',
        where: '',
        orderby: dbOrderBy,
        orderByFieldName: "",
        ...
        exportExcel: {
          "filename": "appointment-project-single.xls",
          "type": "xls",
          "fields": {
